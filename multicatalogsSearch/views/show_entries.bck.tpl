...
<script type="text/javascript">
   ...
   google.setOnLoadCallback(drawChart_catalogs);
     ...
     function drawChart_catalogs() {
        ...
        window.location = location+'index.php?ra_in='+{{ra}}+'+dec_in='{{Dec}}+'+radius_in='{{radius}};
         });
      }
...
function fnFormatDetails(table_id, html) {
  var sOut = "<table id=\"catalogs_" + table_id + "\" style='width: 500px;'>";
  sOut += html;
  sOut += "</table>";
  return sOut;
}
...
%for d in range(1, len(data)):
  % catalog_name = data[d]['catalog_name']
    ...
    %for e_c in extra_columns[catalog_name]:
           columns ={'mDataProp':'{{(e_c.replace("-","_")).replace(" ", "")}}', 'sTitle':'{{!e_c}}'}
           columnsInfo.push(columns)
           fullDetail_row{{d}}.{{(e_c.replace("-","_")).replace(" ","")}}='{{!data[d][e_c]}}'
    % end
...
var iTableCounter = 1;
  ...
  <tr>
   ...
   <td>
       ...
       <div id="piechart_catalogs" align='left' style="width: 500px; height: 300px;"></div>

   </td>
  <td>

  <table class="display"  align="center" id="catalogs" style="width: 500px;">
                        <thead>
                                <tr>
                     ...
                     <div style="display:none">
                           <table id="detailsTable" style="width: 500px;" class="inner_catalogs">
                            <thead>
                           </thead>
                          <tbody></tbody>
                          </table>
